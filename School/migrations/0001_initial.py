    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("byy", models.CharField(default="school", max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("class1", models.CharField(blank=True, max_length=10, null=True)),
                (
                    "status",
                    models.CharField(blank=True, default="T", max_length=1, null=True),
                ),
                (
                    "user",
                    models.OneToOneField(
